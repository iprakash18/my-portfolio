...
import { ArrowLeft, Calendar, Clock, Tag, Share2, Linkedin, ExternalLink } from 'lucide-react';
      ...
      <main className="flex-1 pt-20">
        ...
        <article className="container mx-auto px-4 lg:px-8 max-w-4xl pb-20">
          <div className="mb-8">
            ...
            {post.featured && (
              <Badge className="bg-cyan-500/20 text-cyan-400 border-cyan-500/50 mb-4 ml-2">
                Featured
              </Badge>
            )}
            ...
            <div className="flex flex-wrap items-center gap-6 text-muted-foreground mb-6">
              <div className="flex items-center space-x-2">
                <div className="w-10 h-10 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 flex items-center justify-center text-sm font-bold text-white">
            ...
            <Button
              variant="outline"
              onClick={handleShare}
              className="border-slate-700 hover:border-cyan-500/50 text-slate-300 hover:text-cyan-400"
            >
          ...
          <Card className="bg-slate-800/40 border-slate-700">
            <CardContent className="p-6">
              <div className="flex items-start space-x-4">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 flex items-center justify-center text-xl font-bold text-white flex-shrink-0">
            ...
            <div className="container mx-auto px-4 lg:px-8">
              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                {relatedPosts.map(relatedPost => (
                  <Card
                    key={relatedPost.id}
                    className="bg-slate-800/40 border-slate-700 hover:border-cyan-500/50 transition-all duration-300 group"
                  >
                    <CardContent className="p-6">
                      <Link to={`/blog/${relatedPost.id}`}>
                        <h3 className="text-lg font-bold text-white group-hover:text-cyan-400 transition-colors mb-3 line-clamp-2">
                          {relatedPost.title}
                        </h3>
                      </Link>
